...
Website link
https://nearfinanceprotocol.com

Twitter link
https://twitter.com/nearfinancepro

Telegram channel
https://t.me/nearfinanceprotocolgroup

LinkedIn Page
https://www.linkedin.com/company/near-finance-protocol/

Medium
https://medium.com/@nearfinanceprotocol
*/
...
contract NearFinanceProtocol is Context, IBEP20, Ownable {
    ...
    uint256 private constant MAX = 1000000 * 10**18;
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal = 5;
    ...
    address public boostFund = 0xA46B67240c202EC69D6450Ab4f40FB950120bc39;
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _maxBuyAmount = 50000 * 10**9; //5% buy cap

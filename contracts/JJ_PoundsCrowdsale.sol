...
import "./JJ_PoundsContinuousSale.sol";
import "./JJ_PoundsToken.sol";

contract JJ_PoundsCrowdsale is WhitelistedCrowdsale, CappedCrowdsale, FinalizableCrowdsale {
    ...
    JJ_PoundsContinuousSale public continuousSale;
        ...
        Crowdsale(_startBlock, _endBlock, _initialRate, _wallet)
    {
        ...
        JJ_PoundsToken(token).pause();
    }

    function createTokenContract() internal returns(MintableToken) {
        return new JJ_PoundsToken();
    }

    function createContinuousSaleContract() internal returns(JJ_PoundsContinuousSale) {
        return new JJ_PoundsContinuousSale(rate, wallet, token);
    }
